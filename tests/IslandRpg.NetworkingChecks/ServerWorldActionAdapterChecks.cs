...
internal static class ServerWorldActionAdapterChecks
{
    ...
    private static void MapsEveryWorldAction()
    {
        ...
        [
            ...
            new PlantTreeAction(3, 65.5f, -94.5f, 0, 8),
            new StrikePlantedTreeAction(ObjectReference, 5),
        ...
        [
            ...
            typeof(CookStewIntent),
            typeof(StrikeTrainingDummyIntent),
            typeof(PlantTreeIntent),
            typeof(StrikePlantedTreeIntent),
