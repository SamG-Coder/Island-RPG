...
CombatProtocolClientChecks.Register(checks);
ClientWorldStateChecks.Register(checks);
ItemContainerChecks.Register(checks);
CoreCombatChecks.Register(checks);
CombatAuthorityChecks.Register(checks);
CombatServerIntegrationChecks.Register(checks);
PrivatePlayerStatePublicationChecks.Register(checks);
OrderedPublicationsChecks.Register(checks);
CombatPopulationLimitChecks.Register(checks);
ResourceIdentityChecks.Register(checks);
ResourceLifecycleChecks.Register(checks);
ResourceAuthorityChecks.Register(checks);
SkillPresentationChecks.Register(checks);
...
PlantedTreeWorldTransactionChecks.Register(checks);
